...
const I18n = (() => {
  ...
  const DICT = {
    en: {
      ...
      "banned.searchPlaceholder": "Search player…",
      "banned.noMatch": "No banned player matches your search.",
      ...
      "games.earnedToday": "earned {earned} today",
      "games.playsLeft": "{left} of {cap} plays left today",
      "games.noPlaysLeft": "No plays left today",
      "games.noPlaysLeftToast": "You've used all 2 plays of this game today. Come back after the reset.",
      ...
      "games.listHint": "2 plays of each game a day, 1–50 Coins a play. Resets at midnight (UTC+7).",
      "games.play": "Play",
      "games.rewardNote": "Earn up to <strong>100 Coins</strong> a day from this game.",
    ...
    km: {
      ...
      "banned.searchPlaceholder": "ស្វែងរកអ្នកលេង…",
      "banned.noMatch": "រកមិនឃើញអ្នកលេងដែលត្រូវនឹងការស្វែងរករបស់អ្នកទេ។",
      ...
      "games.earnedToday": "រកបាន {earned} ថ្ងៃនេះ",
      "games.playsLeft": "នៅសល់ {left} ក្នុងចំណោម {cap} ដងថ្ងៃនេះ",
      "games.noPlaysLeft": "អស់ចំនួនលេងថ្ងៃនេះ",
      "games.noPlaysLeftToast": "អ្នកបានលេងហ្គេមនេះគ្រប់ ២ ដងហើយថ្ងៃនេះ។ សូមត្រឡប់មកវិញក្រោយពេលកំណត់ឡើងវិញ។",
      ...
      "games.listHint":
        "លេងបាន ២ ដងក្នុងមួយហ្គេមក្នុងមួយថ្ងៃ, ១–៥០ Coins ក្នុងមួយដង។ កំណត់ឡើងវិញនៅពាក់កណ្តាលអធ្រាត្រ (UTC+7)។",
      "games.play": "លេង",
      "games.rewardNote": "រកបានរហូតដល់ <strong>១០០ Coins</strong> ក្នុងមួយថ្ងៃពីហ្គេមនេះ។",
